...
NetFunnel.Skin = {};
//EditZoneStart ----------------------------------------------------------------
NetFunnel.TS_HOST = 'nfc.kinfa.or.kr';	// Default TS host
NetFunnel.TS_PORT = 443;				// Default TS port
NetFunnel.TS_PROTO = 'https';			// Default TS protocol [http|https]
NetFunnel.TS_QUERY = 'ts.wseq';			// Default request query
NetFunnel.TS_SERVICE_ID = 'service_1';			// Default TS Service id
NetFunnel.TS_ACTION_ID = 'long_term01';			// Default TS Action id
...
//event skin 지정
NetFunnel.TS_SKIN_ID = 'sloanSkin';				// Skin ID (미지정시 default 대기창)
...
(function (top) {
    ...
    NetFunnel.ProgressBar = function (oID, oConfig, doc) {
        ...
        this._oTable = doc.createElement("div");
        this._oTable.style.width = "100%";
        this._oTable.style.height = "100%";
        ...
        var tTbody = doc.createElement("div");
        tTbody.style.display = "flex";
        tTbody.style.height = "100%";
        var tCell = doc.createElement("div");
        tCell.style.height = "100%";
        tCell.style.backgroundColor = this._config.bgcolor;
        var tCell2 = doc.createElement("div");
        tCell2.style.backgroundColor = this._config.bgcolor;
        tTbody.appendChild(tCell);
        tTbody.appendChild(tCell2);
        ...
        this._action = function () {
            try {
                ...
                this._oTable.style.width = this._config.width + "%";
                ...
                this._bar.style.width = barSize + "%";
                this._bar.style.backgroundColor = this._config.color;
                this._bar2.style.width = barSize2 + "%";
    ...
    NetFunnel.ProgressBar.prototype._bgcolor = "#ccc";
    NetFunnel.Cookie = {
    ...
    NetFunnel.SkinUtil = {
        prevID: "", add: function (id, obj, type) {
            try {
    ...
    function NetFunnel_Action(oConfig, oCallbacks) {
        ...
        if (oForm === null) {
            ...
            NetFunnel_getTidChkEnter({
                ...
                }, stop: stop, block: block, ipblock: ipblock, continued: continued
            })
        }
        return false
    }
